...
kNumMixChannels=8
g_max_num_steps=16
if string.find(model,"88+")then
g_model_is_88=true
end
if string.find(model,"25")then
g_model_is_25=true
end
if string.find(model,"GX")or string.find(model,"iX")or string.find(model,"SE")then
g_model_is_iX=true
end
if string.find(model,"LXMini")then
g_model_is_iX=true
g_model_is_lxmini=true
end
...
if g_model_is_lxmini then
ccInstMode=100
ccUserMode=99
end
if not string.find(model,"Mixer")then
local items={}
table.insert(items,{name="Keyboard",input="keyboard"})
table.insert(items,{name="Pitch Bend",input="value",output="value",min=0,max=16383,modes={"NORMAL","OVERRIDE"}})
table.insert(items,{name="Modulation",input="value",output="value",min=0,max=127,modes={"NORMAL","OVERRIDE"}})
table.insert(items,{name="Damper Pedal",input="value",output="value",min=0,max=127,modes={"NORMAL","OVERRIDE"}})
table.insert(items,{name="Expression Pedal",input="value",output="value",min=0,max=127,modes={"NORMAL","OVERRIDE"}})
table.insert(items,{name="Channel Pressure",input="value",output="value",min=0,max=127,modes={"NORMAL","OVERRIDE"}})
table.insert(items,{name="Program Change",input="value",output="value",min=0,max=127,modes={"NORMAL","OVERRIDE"}})
g_last_keyboard_item=7
g_inst_ctrl_first=g_last_keyboard_item+1
for i=0,g_num_instrument_ctrls do
local item_name="Ctrl "..i
table.insert(items,{name=item_name,input="value",output="value",min=0,max=127,modes={"CTRL","TRIGGER"}})
end
g_inst_ctrl_last=table.getn(items)
g_cc_first=table.getn(items)+1
for i=0,127 do
local item_name="MIDI CC "..i
table.insert(items,{name=item_name,input="value",output="value",min=0,max=127})
end
...
table.insert(items,{name=item_name,input="button",output="value",min=0,max=1,modes={"BUTTON","DRUM","DRUM_CTRL"}})
end
g_pad_last=table.getn(items)
g_pad_mute_first=table.getn(items)+1
for i=0,16 do
local item_name="Pad "..(i+1).." Mute"
table.insert(items,{name=item_name,input="value",output="value",min=0,max=2048})
end
...
table.insert(items,{name=item_name,input="value",output="value",min=0,max=g_num_instrument_ctrls})
end
g_pad_drum_last=table.getn(items)
g_drum_first=table.getn(items)+1
for i=0,16 do
local item_name="Drum "..i+1
table.insert(items,{name=item_name,input="button"})
end
...
table.insert(items,{name=item_name,output="value",min=0,max=1})
end
g_step_last=table.getn(items)
g_step_toggle_first=table.getn(items)+1
for i=0,g_max_num_steps do
local item_name="Step "..(i+1).." Toggle"
table.insert(items,{name=item_name,input="button",output="value",min=0,max=1})
end
g_step_toggle_last=table.getn(items)
g_fader_first=table.getn(items)+1
for i=1,g_num_faders do
local item_name="Fader "..i
table.insert(items,{name=item_name,input="value",output="value",min=0,max=g_num_instrument_ctrls,modes={"DEFAULT","NAME","DRUM_MIX"}})
end
g_fader_last=table.getn(items)
g_button_first=table.getn(items)+1
for i=1,g_num_buttons do
local item_name="Button "..i
table.insert(items,{name=item_name,input="value",output="value",min=0,max=g_num_instrument_ctrls,modes={"CTRL","GROUP","MODIFIER1","MODIFIER2","DRUM_MIX","TRIG"}})
end
...
table.insert(items,{name="Shift",input="button"})
table.insert(items,{name="Track Down",input="button"})
table.insert(items,{name="Track Up",input="button"})
table.insert(items,{name="Patch Down",input="button"})
table.insert(items,{name="Patch Up",input="button"})
g_func_last=table.getn(items)
table.insert(items,{name="Default",input="button",output="value"})
g_default=table.getn(items)
table.insert(items,{name="User",input="button"})
g_user=table.getn(items)
table.insert(items,{name="Plugin View",input="button",output="value"})
g_plugin_view=table.getn(items)
table.insert(items,{name="Track Mute",input="button"})
g_track_mute=table.getn(items)
table.insert(items,{name="Track Solo",input="button"})
g_track_solo=table.getn(items)
table.insert(items,{name="Track Auto",input="button"})
g_track_auto=table.getn(items)
g_shift_on=table.getn(items)+1
table.insert(items,{name="Shift On",input="button"})
g_shift_off=table.getn(items)+1
table.insert(items,{name="Shift Off",input="button"})
g_trans_first=table.getn(items)+1
table.insert(items,{name="CLICK",input="button"})
table.insert(items,{name="LOOP",input="button",output="value"})
table.insert(items,{name="REWIND",input="button"})
table.insert(items,{name="FORWARD",input="button"})
table.insert(items,{name="STOP",input="button"})
table.insert(items,{name="PLAY",input="button",output="value"})
table.insert(items,{name="RECORD",input="button",output="value"})
g_trans_last=table.getn(items)
table.insert(items,{name="UNDO",input="button"})
g_undo=table.getn(items)
table.insert(items,{name="QREC",input="button"})
g_qrec=table.getn(items)
table.insert(items,{name="GOTO_L",input="button"})
g_goto_l=table.getn(items)
table.insert(items,{name="GOTO_R",input="button"})
g_goto_r=table.getn(items)
table.insert(items,{name="PRE_COUNT",input="button"})
g_pre_count=table.getn(items)
table.insert(items,{name="Tempo",input="value",output="value",min=0,max=999})
g_tempo=table.getn(items)
table.insert(items,{name="SPP",input="value",output="value",min=0,max=2147483646})
g_song_pos=table.getn(items)
table.insert(items,{name="L Pos",input="value",output="value",min=0,max=2147483646})
g_L_pos=table.getn(items)
table.insert(items,{name="R Pos",input="value",output="value",min=0,max=2147483646})
g_R_pos=table.getn(items)
table.insert(items,{name="L Bar",output="text"})
g_L_bar=table.getn(items)
table.insert(items,{name="R Bar",output="text"})
g_R_bar=table.getn(items)
table.insert(items,{name="Track Name",output="text"})
g_track_name=table.getn(items)
table.insert(items,{name="Device",output="text",modes={"INST","FX","DRUM"}})
g_device_name=table.getn(items)
table.insert(items,{name="Document",output="text"})
g_document_name=table.getn(items)
remote.define_items(items)
local inputs={
{pattern="9? xx 00",name="Keyboard",value="0",note="x",velocity="64",port=g_keyboard_port},
{pattern="8? xx 00",name="Keyboard",value="0",note="x",velocity="64",port=g_keyboard_port},
{pattern="<100x>? yy zz",name="Keyboard",port=g_keyboard_port},
{pattern="e? xx yy",name="Pitch Bend",value="y*128 + x",port=g_keyboard_port},
{pattern="b? 01 xx",name="Modulation",port=g_keyboard_port},
{pattern="b? 40 xx",name="Damper Pedal",port=g_keyboard_port},
{pattern="b? 0B xx",name="Expression Pedal",port=g_keyboard_port},
{pattern="D? xx ??",name="Channel Pressure",port=g_keyboard_port},
{pattern="C? xx",name="Program Change",port=g_keyboard_port},
{pattern="bf 65 ?<???x>",name="CLICK",port=g_control_port},
{pattern="bf 66 ?<???x>",name="LOOP",port=g_control_port},
{pattern="bf 67 ?<???x>",name="REWIND",port=g_control_port},
{pattern="bf 68 ?<???x>",name="FORWARD",port=g_control_port},
{pattern="bf 69 ?<???x>",name="STOP",port=g_control_port},
{pattern="bf 6a ?<???x>",name="PLAY",port=g_control_port},
{pattern="bf 6b ?<???x>",name="RECORD",port=g_control_port},
{pattern="b? 00 xx",name="MIDI CC 0"},
{pattern="b? 01 xx",name="MIDI CC 1"},
{pattern="b? 02 xx",name="MIDI CC 2"},
{pattern="b? 03 xx",name="MIDI CC 3"},
{pattern="b? 04 xx",name="MIDI CC 4"},
{pattern="b? 05 xx",name="MIDI CC 5"},
{pattern="b? 06 xx",name="MIDI CC 6"},
{pattern="b? 07 xx",name="MIDI CC 7"},
{pattern="b? 08 xx",name="MIDI CC 8"},
{pattern="b? 09 xx",name="MIDI CC 9"},
{pattern="b? 0a xx",name="MIDI CC 10"},
{pattern="b? 0b xx",name="MIDI CC 11"},
{pattern="b? 0c xx",name="MIDI CC 12"},
{pattern="b? 0d xx",name="MIDI CC 13"},
{pattern="b? 0e xx",name="MIDI CC 14"},
{pattern="b? 0f xx",name="MIDI CC 15"},
{pattern="b? 10 xx",name="MIDI CC 16"},
{pattern="b? 11 xx",name="MIDI CC 17"},
{pattern="b? 12 xx",name="MIDI CC 18"},
{pattern="b? 13 xx",name="MIDI CC 19"},
{pattern="b? 14 xx",name="MIDI CC 20"},
{pattern="b? 15 xx",name="MIDI CC 21"},
{pattern="b? 16 xx",name="MIDI CC 22"},
{pattern="b? 17 xx",name="MIDI CC 23"},
{pattern="b? 18 xx",name="MIDI CC 24"},
{pattern="b? 19 xx",name="MIDI CC 25"},
{pattern="b? 1a xx",name="MIDI CC 26"},
{pattern="b? 1b xx",name="MIDI CC 27"},
{pattern="b? 1c xx",name="MIDI CC 28"},
{pattern="b? 1d xx",name="MIDI CC 29"},
{pattern="b? 1e xx",name="MIDI CC 30"},
{pattern="b? 1f xx",name="MIDI CC 31"},
{pattern="b? 20 xx",name="MIDI CC 32"},
{pattern="b? 21 xx",name="MIDI CC 33"},
{pattern="b? 22 xx",name="MIDI CC 34"},
{pattern="b? 23 xx",name="MIDI CC 35"},
{pattern="b? 24 xx",name="MIDI CC 36"},
{pattern="b? 25 xx",name="MIDI CC 37"},
{pattern="b? 26 xx",name="MIDI CC 38"},
{pattern="b? 27 xx",name="MIDI CC 39"},
{pattern="b? 28 xx",name="MIDI CC 40"},
{pattern="b? 29 xx",name="MIDI CC 41"},
{pattern="b? 2a xx",name="MIDI CC 42"},
{pattern="b? 2b xx",name="MIDI CC 43"},
{pattern="b? 2c xx",name="MIDI CC 44"},
{pattern="b? 2d xx",name="MIDI CC 45"},
{pattern="b? 2e xx",name="MIDI CC 46"},
{pattern="b? 2f xx",name="MIDI CC 47"},
{pattern="b? 30 xx",name="MIDI CC 48"},
{pattern="b? 31 xx",name="MIDI CC 49"},
{pattern="b? 32 xx",name="MIDI CC 50"},
{pattern="b? 33 xx",name="MIDI CC 51"},
{pattern="b? 34 xx",name="MIDI CC 52"},
{pattern="b? 35 xx",name="MIDI CC 53"},
{pattern="b? 36 xx",name="MIDI CC 54"},
{pattern="b? 37 xx",name="MIDI CC 55"},
{pattern="b? 38 xx",name="MIDI CC 56"},
{pattern="b? 39 xx",name="MIDI CC 57"},
{pattern="b? 3a xx",name="MIDI CC 58"},
{pattern="b? 3b xx",name="MIDI CC 59"},
{pattern="b? 3c xx",name="MIDI CC 60"},
{pattern="b? 3d xx",name="MIDI CC 61"},
{pattern="b? 3e xx",name="MIDI CC 62"},
{pattern="b? 3f xx",name="MIDI CC 63"},
{pattern="b? 40 xx",name="MIDI CC 64"},
{pattern="b? 41 xx",name="MIDI CC 65"},
{pattern="b? 42 xx",name="MIDI CC 66"},
{pattern="b? 43 xx",name="MIDI CC 67"},
{pattern="b? 44 xx",name="MIDI CC 68"},
{pattern="b? 45 xx",name="MIDI CC 69"},
{pattern="b? 46 xx",name="MIDI CC 70"},
{pattern="b? 47 xx",name="MIDI CC 71"},
{pattern="b? 48 xx",name="MIDI CC 72"},
{pattern="b? 49 xx",name="MIDI CC 73"},
{pattern="b? 4a xx",name="MIDI CC 74"},
{pattern="b? 4b xx",name="MIDI CC 75"},
{pattern="b? 4c xx",name="MIDI CC 76"},
{pattern="b? 4d xx",name="MIDI CC 77"},
{pattern="b? 4e xx",name="MIDI CC 78"},
{pattern="b? 4f xx",name="MIDI CC 79"},
{pattern="b? 50 xx",name="MIDI CC 80"},
{pattern="b? 51 xx",name="MIDI CC 81"},
{pattern="b? 52 xx",name="MIDI CC 82"},
{pattern="b? 53 xx",name="MIDI CC 83"},
{pattern="b? 54 xx",name="MIDI CC 84"},
{pattern="b? 55 xx",name="MIDI CC 85"},
{pattern="b? 56 xx",name="MIDI CC 86"},
{pattern="b? 57 xx",name="MIDI CC 87"},
{pattern="b? 58 xx",name="MIDI CC 88"},
{pattern="b? 59 xx",name="MIDI CC 89"},
{pattern="b? 5a xx",name="MIDI CC 90"},
{pattern="b? 5b xx",name="MIDI CC 91"},
{pattern="b? 5c xx",name="MIDI CC 92"},
{pattern="b? 5d xx",name="MIDI CC 93"},
{pattern="b? 5e xx",name="MIDI CC 94"},
{pattern="b? 5f xx",name="MIDI CC 95"},
{pattern="b? 60 xx",name="MIDI CC 96"},
{pattern="b? 61 xx",name="MIDI CC 97"},
{pattern="b? 62 xx",name="MIDI CC 98"},
{pattern="b? 63 xx",name="MIDI CC 99"},
{pattern="b? 64 xx",name="MIDI CC 100"},
{pattern="b? 65 xx",name="MIDI CC 101"},
{pattern="b? 66 xx",name="MIDI CC 102"},
{pattern="b? 67 xx",name="MIDI CC 103"},
{pattern="b? 68 xx",name="MIDI CC 104"},
{pattern="b? 69 xx",name="MIDI CC 105"},
{pattern="b? 6a xx",name="MIDI CC 106"},
{pattern="b? 6b xx",name="MIDI CC 107"},
{pattern="b? 6c xx",name="MIDI CC 108"},
{pattern="b? 6d xx",name="MIDI CC 109"},
{pattern="b? 6e xx",name="MIDI CC 110"},
{pattern="b? 6f xx",name="MIDI CC 111"},
{pattern="b? 70 xx",name="MIDI CC 112"},
{pattern="b? 71 xx",name="MIDI CC 113"},
{pattern="b? 72 xx",name="MIDI CC 114"},
{pattern="b? 73 xx",name="MIDI CC 115"},
{pattern="b? 74 xx",name="MIDI CC 116"},
{pattern="b? 75 xx",name="MIDI CC 117"},
{pattern="b? 76 xx",name="MIDI CC 118"},
{pattern="b? 77 xx",name="MIDI CC 119"},
{pattern="b? 78 xx",name="MIDI CC 120"},
{pattern="b? 79 xx",name="MIDI CC 121"},
{pattern="b? 7a xx",name="MIDI CC 122"},
{pattern="b? 7b xx",name="MIDI CC 123"},
{pattern="b? 7c xx",name="MIDI CC 124"},
{pattern="b? 7d xx",name="MIDI CC 125"},
{pattern="b? 7e xx",name="MIDI CC 126"},
{pattern="b? 7f xx",name="MIDI CC 127"},
{pattern="bf 26 xx",name="Fader 1"},
{pattern="bf 27 xx",name="Fader 2"},
{pattern="bf 28 xx",name="Fader 3"},
{pattern="bf 29 xx",name="Fader 4"},
{pattern="bf 2a xx",name="Fader 5"},
{pattern="bf 2b xx",name="Fader 6"},
{pattern="bf 2c xx",name="Fader 7"},
{pattern="bf 2d xx",name="Fader 8"},
{pattern="bf 2e xx",name="Fader 9"},
{pattern="bf 2f xx",name="Button 1"},
{pattern="bf 30 xx",name="Button 2"},
{pattern="bf 31 xx",name="Button 3"},
{pattern="bf 32 xx",name="Button 4"},
{pattern="bf 33 xx",name="Button 5"},
{pattern="bf 34 xx",name="Button 6"},
{pattern="bf 35 xx",name="Button 7"},
{pattern="bf 36 xx",name="Button 8"},
{pattern="bf 37 xx",name="Button 9"},
{pattern="bf 38 xx",name="Knob 1"},
{pattern="bf 39 xx",name="Knob 2"},
{pattern="bf 3a xx",name="Knob 3"},
{pattern="bf 3b xx",name="Knob 4"},
{pattern="bf 3c xx",name="Knob 5"},
{pattern="bf 3d xx",name="Knob 6"},
{pattern="bf 3e xx",name="Knob 7"},
{pattern="bf 3f xx",name="Knob 8"},
{pattern="bf 6c ?<???x>",name="Shift"},
{pattern="bf 6d ?<???x>",name="Track Down",port=g_control_port},
{pattern="bf 6e ?<???x>",name="Track Up",port=g_control_port},
{pattern="bf 6f ?<???x>",name="Patch Down",port=g_control_port},
{pattern="bf 70 ?<???x>",name="Patch Up",port=g_control_port},
}
...
for i=1,g_num_faders do
local item_name="Fader "..i
table.insert(items,{name=item_name,input="value",output="value",min=0,max=g_fader_max})
end
g_fader_last=table.getn(items)
g_button_first=table.getn(items)+1
for i=1,g_num_buttons do
local item_name="Button "..i
table.insert(items,{name=item_name,input="button",output="value",min=0,max=1,modes={"NORMAL","MIXER"}})
end
g_button_last=table.getn(items)
g_knob_first=table.getn(items)+1
for i=1,g_num_knobs do
...
g_knob_last=table.getn(items)
g_mute_first=table.getn(items)+1
for i=1,kNumMixChannels do
local item_name="Mute "..i
table.insert(items,{name=item_name,input="button",output="value",min=0,max=1})
end
g_mute_last=table.getn(items)
g_solo_first=table.getn(items)+1
for i=1,kNumMixChannels do
local item_name="Solo "..i
table.insert(items,{name=item_name,input="button",output="value",min=0,max=1})
end
g_solo_last=table.getn(items)
table.insert(items,{name="Bank Up",input="button"})
g_bank_up=table.getn(items)
table.insert(items,{name="Bank Down",input="button"})
g_bank_down=table.getn(items)
remote.define_items(items)
local inputs={
{pattern="bf 0c xx",name="Fader 1"},
{pattern="bf 0d xx",name="Fader 2"},
{pattern="bf 0e xx",name="Fader 3"},
{pattern="bf 0f xx",name="Fader 4"},
{pattern="bf 10 xx",name="Fader 5"},
{pattern="bf 11 xx",name="Fader 6"},
{pattern="bf 12 xx",name="Fader 7"},
{pattern="bf 13 xx",name="Fader 8"},
{pattern="bf 14 xx",name="Fader 9"},
{pattern="bf 15 xx",name="Button 1"},
{pattern="bf 16 xx",name="Button 2"},
{pattern="bf 17 xx",name="Button 3"},
{pattern="bf 18 xx",name="Button 4"},
{pattern="bf 19 xx",name="Button 5"},
{pattern="bf 1a xx",name="Button 6"},
{pattern="bf 1b xx",name="Button 7"},
{pattern="bf 1c xx",name="Button 8"},
{pattern="bf 1d xx",name="Button 9"},
{pattern="bf 1e xx",name="Knob 1"},
{pattern="bf 1f xx",name="Knob 2"},
{pattern="bf 20 xx",name="Knob 3"},
{pattern="bf 21 xx",name="Knob 4"},
{pattern="bf 22 xx",name="Knob 5"},
{pattern="bf 23 xx",name="Knob 6"},
{pattern="bf 24 xx",name="Knob 7"},
{pattern="bf 25 xx",name="Knob 8"},
}
remote.define_auto_inputs(inputs)
end
end
...
if checksum==128 then checksum=0 end
...
if pad>=kNumPads then return end
if pad==0 then note=ntPad1 end
if pad==1 then note=ntPad2 end
if pad==2 then note=ntPad3 end
if pad==3 then note=ntPad4 end
if pad==4 then note=ntPad5 end
if pad==5 then note=ntPad6 end
if pad==6 then note=ntPad7 end
if pad==7 then note=ntPad8 end
return midiNotevalue(16,note,pad_states[pad+offset])
end
local function send_led_button_state(btn)
if btn>=kNumMixChannels then return end
...
if g_device=="Mixer"then return end
...
local one_loop={}
if gLoopStart+gLoopOffset+numBarsIntoTimeline>kMaxLengthOfSong then return end
...
if R_pos<L_pos then return end
...
for i=0,table.getn(ctrl_targets)do
if grabbed_ctrls[i]then ctrl_targets[i]=grabbed_ctrls[i]
else ctrl_targets[i]=remote.get_item_value(g_fader_first+i)
end
end
else
local stop=g_knob_last-g_fader_first
for i=0,stop do
if remote.is_item_enabled(g_fader_first+i)then ctrl_targets[i]=remote.get_item_value(g_fader_first+i)end
end
end
...
if ins[1]then
local oneResult={in_ports={ins[table.getn(ins)],ins[table.getn(ins)]-1},out_ports={MidiOutPort}}
...
if remote.get_item_value(g_trans_first+5)>0 then return true
else return false end
end
local function isRecording()
if remote.get_item_value(g_trans_last)>0 then return true
else return false end
end
local function isLooping()
if remote.get_item_value(g_trans_first+1)>0 then return true
else return false end
end
...
if g_update_R_locator then
g_update_R_locator=nil
local msg={time_stamp=event.time_stamp,item=g_R_pos,value=gLoopR}
...
if value>0 then
local msg={time_stamp=event.time_stamp,item=g_bank_down,value=1}
remote.handle_input(msg)
return true
end
elseif ctrl==ccMixButton1+1 then
if value>0 then
local msg={time_stamp=event.time_stamp,item=g_bank_up,value=1}
remote.handle_input(msg)
return true
end
end
...
local msg={time_stamp=event.time_stamp,item=g_mod1_first+set_modifier_1,value=1}
remote.handle_input(msg)
set_modifier_1=nil
end
if set_modifier_2 then
local msg={time_stamp=event.time_stamp,item=g_mod2_first+set_modifier_2,value=1}
remote.handle_input(msg)
set_modifier_2=nil
end
...
gLastActiveScene=0
update_loop_presets()
if gPadMode==pd_scenes then return true end
end
if gPadMode==pd_scenes then
gPadMode=pd_notes
resetPadColor()
...
if gPadMode==pd_scenes then
if value==0 then return true end
if ctrl==ntPad1 then pad_note=0 end
if ctrl==ntPad2 then pad_note=1 end
if ctrl==ntPad3 then pad_note=2 end
if ctrl==ntPad4 then pad_note=3 end
if ctrl==ntPad5 then pad_note=4 end
if ctrl==ntPad6 then pad_note=5 end
if ctrl==ntPad7 then pad_note=6 end
if ctrl==ntPad8 then pad_note=7 end
local L_pos
local R_pos
if ShiftMode then
...
if L_pos then
gLoopL=L_pos
local msg={time_stamp=event.time_stamp,item=g_L_pos,value=gLoopL}
remote.handle_input(msg)
end
if R_pos then
gLoopR=R_pos
...
local msg={time_stamp=event.time_stamp,item=g_R_pos,value=val}
remote.handle_input(msg)
end
if not isLooping()then
local msg={time_stamp=event.time_stamp,item=g_trans_first+1,value=1}
remote.handle_input(msg)
end
if not isPlaying()then
local msg={time_stamp=event.time_stamp,item=g_song_pos,value=gLoopL}
remote.handle_input(msg)
local msg={time_stamp=event.time_stamp,item=g_trans_first+5,value=1}
remote.handle_input(msg)
end
gLastActiveScene=pad_note
return true
...
local msg={time_stamp=event.time_stamp,item=id,value=val}
remote.handle_input(msg)
return true
end
if gPadMode==pd_notes then
if ctrl==ntPad1 then pad_note=drum_triggers[0+offset]end
if ctrl==ntPad2 then pad_note=drum_triggers[1+offset]end
if ctrl==ntPad3 then pad_note=drum_triggers[2+offset]end
if ctrl==ntPad4 then pad_note=drum_triggers[3+offset]end
if ctrl==ntPad5 then pad_note=drum_triggers[4+offset]end
if ctrl==ntPad6 then pad_note=drum_triggers[5+offset]end
if ctrl==ntPad7 then pad_note=drum_triggers[6+offset]end
if ctrl==ntPad8 then pad_note=drum_triggers[7+offset]end
local msg={time_stamp=event.time_stamp,item=1,value=1,note=pad_note,velocity=event[3]}
remote.handle_input(msg)
ctrl=pad_note
...
local msg={time_stamp=event.time_stamp,item=g_inst_ctrl_first+tgt,value=state}
remote.handle_input(msg)
return true
end
end
if(status>=ntMsgCh1 and status<=ntMsgCh16 and value==0)or(status>=ntOffMsgCh1 and status<=ntOffMsgCh16)then
start=0
stop=16
for i=start,stop do
...
local msg={time_stamp=event.time_stamp,item=g_drum_first+drum,value=1}
remote.handle_input(msg)
...
local msg={time_stamp=event.time_stamp,item=g_inst_ctrl_first+remote.get_item_value(3),value=value}
remote.handle_input(msg)
return true
else
return false
...
local msg={time_stamp=event.time_stamp,item=g_inst_ctrl_first+remote.get_item_value(4),value=value}
remote.handle_input(msg)
return true
else
return false
...
if g_user_page_active then
local msg={time_stamp=event.time_stamp,item=g_default,value=1}
remote.handle_input(msg)
g_user_page_active=false
else
if not drum_is_active then
local msg={time_stamp=event.time_stamp,item=g_user,value=1}
remote.handle_input(msg)
...
local msg={time_stamp=event.time_stamp,item=index,value=1}
remote.handle_input(msg)
return true
end
...
local msg={time_stamp=event.time_stamp,item=g_plugin_view,value=1}
remote.handle_input(msg)
end
else
if ctrl==ccInstMode then
...
gMixerMode=true
if g_device=="Mixer"and g_model_is_88 then sysSetButtonLedColor(true)end
else
gMixerMode=false
end
end
...
if g_device~="Mixer"then
if value>0 then
local msg={time_stamp=event.time_stamp,item=ctrl-ccShift+g_func_first,value=1}
remote.handle_input(msg)
end
end
return true
...
local msg={time_stamp=event.time_stamp,item=g_song_pos,value=spp}
remote.handle_input(msg)
local index=ctrl-ccTransRew+g_L_pos
local msg={time_stamp=event.time_stamp,item=index,value=spp}
remote.handle_input(msg)
return true
end
end
...
local msg={time_stamp=event.time_stamp,item=g_undo,value=1}
remote.handle_input(msg)
elseif ctrl==ccTransRew then
local msg={time_stamp=event.time_stamp,item=g_goto_l,value=1}
remote.handle_input(msg)
elseif ctrl==ccTransFwd then
local msg={time_stamp=event.time_stamp,item=g_goto_r,value=1}
remote.handle_input(msg)
elseif ctrl==ccTransPlay then
local msg={time_stamp=event.time_stamp,item=g_pre_count,value=1}
remote.handle_input(msg)
elseif ctrl==ccTransRec then
local msg={time_stamp=event.time_stamp,item=g_qrec,value=1}
remote.handle_input(msg)
end
return true
end
...
if ShiftMode then
local msg={time_stamp=event.time_stamp,item=g_trans_first,value=1}
remote.handle_input(msg)
return true
else
if isPlaying()then
local msg={time_stamp=event.time_stamp,item=g_trans_first+4,value=1}
remote.handle_input(msg)
return true
end
end
...
if not g_last_default_user_led_status then setDefaultUserLEDStatus(k_on)end
...
local offset=gPadBank*kNumPads
if ctrl>=ccFader1 and ctrl<=ccFader8 and remote.get_item_mode(g_fader_first+ctrl-ccFader1)==3 then
local drum_vol=pad_drum_volume[input_item+offset]
if remote.get_item_text_value(g_device_name)=="Kong"then
drum_vol=12+29*pad_drum_assignments[input_item+offset]
if pad_drum_assignments[input_item+offset]==pad_drum_assignments[g_last_drum_fader]
and g_last_drum_fader~=input_item+offset then
...
if ctrl>=ccButton1 and ctrl<ccButton9 and remote.get_item_mode(g_button_first+ctrl-ccButton1)==5 then
if value>0 then
...
if mode==2 then
if value>0 then
local msg={time_stamp=event.time_stamp,item=g_group_first+ctrl-ccButton1,value=1}
remote.handle_input(msg)
end
mute_all_ctrls()
return true
...
local msg={time_stamp=event.time_stamp,item=item_index,value=value}
remote.handle_input(msg)
return true
end
if value==0 then
...
if btnMode==pd_solo then tgt=g_solo_first end
tgt=tgt+input_item-g_button_first
local msg={time_stamp=event.time_stamp,item=tgt,value=1}
remote.handle_input(msg)
else
local msg={time_stamp=event.time_stamp,item=input_item,value=1}
remote.handle_input(msg)
end
return true
end
...
g_last_ctrl=ctrl
local msg={time_stamp=event.time_stamp,item=input_item,value=value}
remote.handle_input(msg)
return true
...
for i=start,stop do
if remote.is_item_enabled(g_pad_drum_first+i)and remote.get_item_value(g_pad_drum_first+i)==ctrl_item then
pad_drum_assignments[i]=tonumber(remote.get_item_text_value(item_index))
end
if remote.is_item_enabled(g_pad_mute_first+i)and remote.get_item_value(g_pad_mute_first+i)==ctrl_item then
pad_mutes[i]=remote.get_item_value(item_index)
end
if remote.is_item_enabled(g_pad_solo_first+i)and remote.get_item_value(g_pad_solo_first+i)==ctrl_item then
pad_solos[i]=remote.get_item_value(item_index)
end
if remote.is_item_enabled(g_pad_first+i)and remote.get_item_value(g_pad_first+i)==ctrl_item then
...
for i=start,stop do
if remote.is_item_enabled(g_button_first+i)and remote.get_item_value(g_button_first+i)==ctrl_item then
...
if remote.is_item_enabled(item_index)then
pad_drum_assignments[item_index-g_pad_drum_first]=tonumber(remote.get_item_text_value(g_inst_ctrl_first+remote.get_item_value(item_index)))
else
...
if grabbed_ctrls[item_index-g_fader_first]then ctrl_targets[item_index-g_fader_first]=grabbed_ctrls[item_index-g_fader_first]
else
if gLastDeviceName==remote.get_item_text_value(g_device_name)then ctrl_targets[item_index-g_fader_first]=remote.get_item_value(item_index)
end
end
else
if g_user_page_active then
...
if not ctrl_targets[item_index-g_fader_first]then ctrl_targets[item_index-g_fader_first]=remote.get_item_value(item_index)end
...
if ShiftMode then
if not gPadShiftSent then displayPadShiftState()end
else
...
if mixChannel_solos[i]and mixChannel_solos[i]>0 then led_button_colors[i]=padColor.green_red end
if mixChannel_mutes[i]and mixChannel_mutes[i]>0 then led_button_colors[i]=padColor.red_green end
